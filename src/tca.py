## https://github.com/m-qiang/CortexODE/blob/main/util/tca.py
## Credits: Nicolas Niederhausen
...
class topology():
    ...
    """
    def __init__(self):
        bit, lut = tca_init_fill(os.path.join(package_directory, 'critical186LUT.raw.gz'), threshold=1.0)
        self.bit = bit
        self.lut = lut
